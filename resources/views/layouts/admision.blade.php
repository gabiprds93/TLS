...
<div id="section1" class="section">
	@if(count($secciones[2]->contenidos) > 0)
		@foreach($secciones[2]->contenidos as $co)
							...
							<div class="tittle">
								...
								@else
									<div class="pseudoBreadCrumb">
										<h5 class="light italic" style="color:#{{ $co->color_detalle }}">{{ $secciones[2]->nombre }} / <span class="letterYellow">{{ $co->titulo }}</span></h5>
									</div>
								@endif
								<!--Seccion de Migaja o Imagen de APP -->
